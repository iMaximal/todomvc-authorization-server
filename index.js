...
const checkJwt = jwt({
  ...
  secret: jwksRsa.expressJwtSecret({
    ...
    jwksUri: 'https://maximal.auth0.com/.well-known/jwks.json',
  }),

  // Validate the audience and the issuer.
  audience: 'https://todomvc-authorization',
  issuer: 'https://maximal.auth0.com/',
  algorithms: ['RS256']
});
...
const getUserInfo = (token) => {
  return fetch('https://maximal.auth0.com/userinfo', {
...
const appbaseRef = new Appbase({
  ...
  app: "imaximal",
  credentials: "LA0yAedAt:1d1e2808-4571-4303-839e-55b7ae16f71e"
});
